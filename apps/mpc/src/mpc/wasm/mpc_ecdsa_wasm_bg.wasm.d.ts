...
export function signer_export_complete_state(a: number, b: number): void;
export function signer_partial_from_complete_state(a: number, b: number, c: number, d: number): void;
